...
BEGIN TRY
    INSERT Invoices
VALUES
    (799, 'ZXK-799', '2020-03-07', 299.95, 0, 0,
        1, '2020-04-06', NULL);
...
IF (SELECT MAX(CreditTotal)
FROM #InvoiceCopy) > 3000
        BREAK;
...
INSERT Vendors
    (VendorName, VendorAddress1, VendorCity, VendorState,
    VendorZipCode, VendorPhone, DefaultTermsID, DefaultAccountNo)
VALUES
    ('Peerless Binding', '1112 S Windsor St', 'Hallowell', 'ME',
...
IF @MyRowCount = 1
    INSERT Invoices
VALUES
    (@MyIdentity, 'BA-0199', '2020-03-01', 4598.23,
